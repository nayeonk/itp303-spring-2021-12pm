...
if ( !isset($_POST['email']) || empty($_POST['email'])
	...
	// Before creating a new user, check the user table to see if the user and/or email address already exists.
	...
	if($results_registered->num_rows > 0) {
		...
		// SQL to insert! use prepared statements or raw
		...
		// $prepared_statement = "INSERT INTO users(username, email, password) VALUES(?, ?, ?)"

		// $statement = $mysqli->prepare($prepared_statement);
